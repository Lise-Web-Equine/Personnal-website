<template>
  <NuxtLayout>
    <PageHeader 
      ...
      description="Règles d'utilisation du site Lise Web Equine"
    />
...
useHead({
  title: 'CGU - Lise Web Equine',
  meta: [
    { name: 'description', content: 'Conditions générales d\'utilisation du site Lise Web Equine.' }
  ]
})
</script>
