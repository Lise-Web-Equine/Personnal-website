        ...
        <div class="container mx-auto px-6">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div v-motion-slide-visible-once-bottom>
              ...
              <p class="text-xl md:text-2xl text-secondary-600 leading-relaxed">
        ...
        <div class="container mx-auto px-6">
          <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div 
                class="text-center p-8 bg-white rounded-2xl border border-secondary-200 hover:border-secondary-300 transition-colors"
              ...
              >
                ...
                <h3 class="text-xl font-bold mb-4 text-secondary-900">Passion Équine</h3>
              ...
              >
                ...
                <h3 class="text-xl font-bold mb-4 text-secondary-900">Excellence</h3>
                <p class="text-secondary-600 leading-relaxed">
              ...
              >
                ...
                <h3 class="text-xl font-bold mb-4 text-secondary-900">Innovation</h3>
                <p class="text-secondary-600 leading-relaxed">
