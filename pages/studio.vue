<template>
  <NuxtLayout>
      <PageHeader
        title="Le Studio de création web équestre"
...
const studioAIFeatures = [
  {
    ...
    description: 'Des animations dynamiques qui réagissent aux interactions des visiteurs pour créer une expérience immersive et mémorable.'
  },
  {
    icon: Code,
    iconColor: 'text-primary-500',
    title: 'Sur mesure',
    description: 'Chaque fonctionnalité IA est adaptée à votre activité et à vos valeurs pour un accompagnement qui vous ressemble vraiment.'
  }
]
...
useHead({
  title: 'Studio sur-mesure - Sites web pour professionnels équestres | Lise Web Equine',
  meta: [
    ...
    { property: 'og:title', content: 'Studio sur-mesure - Sites web pour professionnels équestres' },
    ...
    { name: 'twitter:title', content: 'Studio sur-mesure - Sites web pour professionnels équestres' },
